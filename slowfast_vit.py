...
def get_compiled_model():
    ...
    full_x = layers.Concatenate()([x, x3])
    full_x = layers.Dense(512, activation='relu')(full_x)
...
def run_experiment():
    filepath = f"../source/slowfast_temp_vit_checkpoint_{MY_DENSE_DIM}_{MY_NUM_HEADS}_{MY_DROPOUT}_{today_str}"
    ...
    #save the model
    model.save(f'../results/models/slowfast_temp_vit_{MY_DENSE_DIM}_{MY_NUM_HEADS}_{MY_DROPOUT}_{today_str}.h5')
...
preds_df.to_csv(f'../results/preds/preds_slowfast_temp_vit_{MY_DENSE_DIM}_{MY_NUM_HEADS}_{MY_DROPOUT}_{today_str}.csv')
true_df.to_csv(f'../results/preds/true_slowfast_temp_vit_{MY_DENSE_DIM}_{MY_NUM_HEADS}_{MY_DROPOUT}_{today_str}.csv')
...
preds_df.to_csv(f'../results/preds/val_preds_slowfast_temp_vit_{MY_DENSE_DIM}_{MY_NUM_HEADS}_{MY_DROPOUT}_{today_str}.csv')
true_df.to_csv(f'../results/preds/val_true_slowfast_temp_vit_{MY_DENSE_DIM}_{MY_NUM_HEADS}_{MY_DROPOUT}_{today_str}.csv')